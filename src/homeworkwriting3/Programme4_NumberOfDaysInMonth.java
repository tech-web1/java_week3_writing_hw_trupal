 ...
 * The parameter needs to be grater than or equal to 1 and less than or equal to
 * 9999.If the parameter is not in that range ,calculate if the year is a leap year and return true if it is,
 ...
 *   NOTE: Methods isLeapYear and getDa
 */
