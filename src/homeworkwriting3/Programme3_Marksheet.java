...
/**
 * Write a java progreamme to input student Name roll No,and three subjects Math,Science and
 * English marks (marks is between 0 to100 and if is out of range print error message "Invalid
 * Input,Marks should between 0 to100")and find out total,percentage and result.
...
public class Programme3_Marksheet {
    public static void main(String[] args) {
        ...
        System.out.print("/nEnter student Name    \t \t:\t");
